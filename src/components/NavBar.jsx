    ...
    <>
      ...
      >
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          >
            <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-cyan-400/20 bg-cyan-400/10 transition duration-300 group-hover:border-cyan-400/40 group-hover:bg-cyan-400/15">
